...
//import com.amosyuen.videorecorder.interfaces.ApiClient;
//import com.amosyuen.videorecorder.interfaces.ApiInterface;
/*
...
public class FFmpegRecorderActivity extends AbstractDynamicStyledActivity implements
    ...
    /* private void downloadVideo(final String url, final DownloadProgressListener downloadProgressListener) {
     ...
     private boolean writeResponseBodyToDisk(ResponseBody body, String fileName, DownloadProgressListener downloadProgressListener) {
         ...
         try {
             File file = new File(FFmpegRecorderActivity.this.getExternalFilesDir(null) + File.separator + fileName);
 ...
 */
    ...
    protected class SaveVideoTask extends AsyncTask<Object, Object, Exception>
        ...
        protected Exception doInBackground(Object... params) {
            ...
            Log.d(LOG_TAG, "VideoRecorder path uri " + Uri.parse(mParams.getVideoOutputFileUri()).getPath());
