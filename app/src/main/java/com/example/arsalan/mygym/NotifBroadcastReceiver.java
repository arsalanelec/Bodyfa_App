...
public class NotifBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getAction().equals(context.getPackageName()+".co.ronash.pushe.NOTIF_CLICKED")){
            Log.i("Pushe", "Broadcast co.example.pushe.NOTIF_CLICKED received");
            //add your logic here
        }
        else if(intent.getAction().equals(context.getPackageName()+".co.ronash.pushe.NOTIF_DISMISSED")){
            Log.i("Pushe", "Broadcast co.example.pushe.NOTIF_DISMISSED received");
            //add your logic here
        }
            ...
            Log.i("Pushe", "Broadcast co.example.pushe.NOTIF_BTN_CLICKED received. BtnId =  " + btnId);
            //add your logic here
        }
    }
}
