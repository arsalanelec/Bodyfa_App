...
package com.example.arsalan.mygym.cview;
...
public class CircularProgressBar extends ProgressBar{
	...
	public void init(AttributeSet attrs, int style){
		...
		mTitlePaint.setTextSize(MyUtil.dpToPixel(22,getResources()));
		...
		mSubtitlePaint.setTextSize(MyUtil.dpToPixel(14,getResources()));
